...
export const approvalRequestSchema = z.object({
  ...
  tool_input: z.string().max(10_000).optional(),
  prompt_text: z.string().optional(),
  prompt_options: z.string().optional(),
  terminal_context: z.string().max(10_000).optional(),
...
export const approvalPolicyRuleSchema = z.object({
  ...
  match_request_type: z.array(approvalRequestTypeSchema).optional(),
  ...
  match_risk_level: z.array(riskLevelSchema).optional(),
